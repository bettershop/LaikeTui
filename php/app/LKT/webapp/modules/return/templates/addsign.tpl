...
$(".qd").click(function(){
    var id = $('input[name=id]').val(); // 订单号
    var sNo = $('input[name=sNo]').val(); // 订单号
	...
	$.ajax({
		url:"index.php?module=return&action=addsign",
		type:"post",
		data:{sNo:sNo,id:id,trade:3,express:express,courier_num:courier_num,otype:otype,express_name:express_name},
		dataType:"json",

                                            ...
                                            <div id='poster'>
                                                ...
                                                {if $data != ''}
                                                    ...
                                                    {foreach from=$data item=d key=key name=f1}
                                                        <div class="drag" type="{$d->type}" index="{$key+1}"
                                                             style="zindex:{$key+1};left:{$d->left};top:{$d->top};
                                                            ...
                                                            {elseif $d->type =='nickname'}
                                                                <div class=text
                                                                     style="font-size:{$d->size};color:{$d->color}">昵称
                                                                </div>
                                                            {elseif $d->type =='title'}
                                                                <div class=text
                                                                     style="font-size:{$d->size};color:{$d->color}">商品名称
                                                                </div>
                                                            {elseif $d->type =='marketprice'}
                                                                <div class=text
                                                                     style="font-size:{$d->size};color:{$d->color}">商品现价
                                                                </div>
                                                            {elseif $d->type =='productprice'}
                                                                <div class=text
                                                                     style="font-size:{$d->size};color:{$d->color}">商品原价
                                                                </div>
                                                            {/if}
                                                    ...
                                                    <div class="form-group" id="bgset">
                                                        ...
                                                        <div class="col-sm-9 col-xs-12">
                                                            ...
                                                            <div class="input-group ">
                                                                ...
                                                                <input type="text" name="bg" value="{$res->bg}"
        ...
        <button class="btn btn-default" type="button" onclick="showImageDialog(this);">选择图片</button>
            ...
            <button class="btn btn-default colorclean" type="button"><span><i class="fa fa-remove"></i></span></button>
                                                    ...
                                                    <div class="form-group" id="imgset" style="display:none">
                                                        ...
                                                        <div class="col-sm-9 col-xs-12">
                                                            <div class="input-group ">
                                                                <input type="text" name="img" value="{$res->image}"
                                                                       class="form-control" autocomplete="off">

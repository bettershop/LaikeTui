<?php /* Smarty version 2.6.26, created on 2021-01-17 09:54:10
         compiled from pay.tpl */ ?>
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="mch_id" value="<?php echo $this->_tpl_vars['mch_id']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="mch_key" value="<?php echo $this->_tpl_vars['mch_key']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl" style="display:none">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="mch_cert" value="<?php echo $this->_tpl_vars['mch_cert']; ?>
" class="input-text">

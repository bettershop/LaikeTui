<?php /* Smarty version 2.6.26, created on 2021-04-02 11:04:48
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="number" name="config[min_inventory]" value="<?php echo $this->_tpl_vars['config']->min_inventory; ?>
" id="min_inventory" class="input-text" style="width:140px">
                </div>
            </div>
        </div>
        <div class="row cl">

<?php /* Smarty version 2.6.26, created on 2022-02-10 15:55:00
...
nopic.jpg' style="height:100px;width:150">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10"> 
                <script id="editor" type="text/plain" name="detail" style="width:100%;height:400px;"><?php echo $this->_tpl_vars['detail']; ?>
</script>

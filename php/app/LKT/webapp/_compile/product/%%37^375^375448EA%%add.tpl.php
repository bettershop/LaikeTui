<?php /* Smarty version 2.6.26, created on 2021-01-30 15:13:55
...
<div class="pd-20" id="page">
    <form id="form1" name="form1" action="" class="form form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return check(this);">
        <input type="hidden" name="attribute" class="attribute" id="attribute" value='<?php echo $this->_tpl_vars['attribute']; ?>
'/>
        <input type="hidden" name="uploadImg" value="<?php echo $this->_tpl_vars['uploadImg']; ?>
"/>
        <input type="hidden" name="attribute_num" class="attribute_num" id="attribute_num" value='<?php echo $this->_tpl_vars['attribute_num']; ?>
'/>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                ...
                <?php if ($this->_tpl_vars['image']): ?>
                    <img id="thumb_url" src='<?php echo $this->_tpl_vars['image']; ?>
' style="height:160px;width:160px">
                    <input type="hidden" name="oldpic" value="<?php echo $this->_tpl_vars['image']; ?>
">
                <?php else: ?>
                ...
                <input type="hidden" id="picurl" value="<?php echo $this->_tpl_vars['image']; ?>
" name="image" datatype="*" nullmsg="请选择图片"/>
...
" placeholder="请填入数字" id="weightId" name="weight">
            </div>
            ...
            <div class="formContentSD">
                <div class="formListSD">
                    ...
                    <div class="formInputSD">
                        <input type="text" name="initial[cbj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_cbj(this);" value="<?php echo $this->_tpl_vars['initial']->cbj; ?>
" placeholder="请设置商品的默认成本价" >
                    </div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>原价：</span></div>
                    <div class="formInputSD"><input type="text" name="initial[yj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->yj; ?>
" placeholder="请设置商品的默认原价" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>售价：</span></div>
                    <div class="formInputSD"><input type="text" name="initial[sj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_sj(this);" value="<?php echo $this->_tpl_vars['initial']->sj; ?>
" placeholder="请设置商品的默认售价" ></div>
                </div>
                <div class="formListSD">
                    ...
                    <div class="formInputSD">
                        <select name="initial[unit]" class="select " style="width: 300px;" id="unit">
                            ...
                            <?php if ($this->_tpl_vars['initial']->unit != ''): ?>
                                <option selected="selected" value="<?php echo $this->_tpl_vars['initial']->unit; ?>
"><?php echo $this->_tpl_vars['initial']->unit; ?>
                ...
                <div class="formListSD">
                    ...
                    <div class="formInputSD">
                        <input type="number" name="initial[kucun]" oninput="value=value.replace(/[^\d]/g,'')" min="0" step="1" onblur="set_kucun(this);" value="<?php echo $this->_tpl_vars['initial']->kucun; ?>
    ...
    background-color: black;">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8 skin-minimal">
                ...
                <div class="ra1">
                    <input name="s_type[]" type="checkbox" id="sex-1" class="inputC" value="1" <?php if (in_array ( 1 , $this->_tpl_vars['s_type'] )): ?>checked="checked"<?php endif; ?>>
                    <label for="sex-1">新品</label>
                </div>
                
                <div class="ra1">
                    <input type="checkbox" id="sex-2" name="s_type[]" class="inputC" value="2" <?php if (in_array ( 2 , $this->_tpl_vars['s_type'] )): ?>checked="checked"<?php endif; ?>>
                    <label for="sex-2">热销</label>
                </div>
                
                <div class="ra1">
                    <input type="checkbox" id="sex-3" name="s_type[]" class="inputC" value="3" <?php if (in_array ( 3 , $this->_tpl_vars['s_type'] )): ?>checked="checked"<?php endif; ?>>
                    <label for="sex-3">推荐</label>
                </div>
                
                <div class="ra1" style="width:100px;">
                    <input type="checkbox" id="sex-4" name="s_type[]" class="inputC" value="4" <?php if (in_array ( 3 , $this->_tpl_vars['s_type'] )): ?>checked="checked"<?php endif; ?>>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-2">
                <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['volume']; ?>
" id="volumeId" name="volume">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-2"> <!-- <span class="select-box"> -->
                <select name="freight" id="freightId" class="select">
                    <?php $_from = $this->_tpl_vars['freight']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f2'] = array('total' => count($_from), 'iteration' => 0);
...
//控制价格显示小数点2位
            ...
            var map = new Map();
            var leve1 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve1']; ?>
<?php echo '"
            var leve2 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve2']; ?>
<?php echo '"
            var leve3 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve3']; ?>
<?php echo '"
            var listA = [
            ...
            var is1 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve']; ?>
<?php echo '"
            var page = new Vue({
                el: "#page",
                data: {

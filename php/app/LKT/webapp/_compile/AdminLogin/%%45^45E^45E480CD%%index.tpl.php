<?php /* Smarty version 2.6.26, created on 2021-02-15 13:08:19
...
?>
			<dl class="menu-system">
				<dt <?php if (($this->_foreach['f1']['iteration']-1) == 0 && $this->_tpl_vars['type'] != 0): ?>class="selected"<?php endif; ?> >
					<span class="asideImgWrap">
...
" style="width: 19px;height: 18px;"/>
				...
				<dd <?php if (($this->_foreach['f1']['iteration']-1) == 0 && $this->_tpl_vars['type'] != 0): ?>style="display: block;"<?php endif; ?> >
					<ul>
			...
			<form  action="javascript:void(0);" method="post">
				...
				<div class="mezl_div">
					<div class="mezl_img">
						...
						<div class="mezl_name"><?php echo $this->_tpl_vars['r'][0]->name; ?>
</div>
						<div class="mezl_zhz"><?php echo $this->_tpl_vars['r'][0]->role1; ?>
</div>
					</div>
				</div>
				...
				<div class="iptDiv">
					...
					<div class="iptRight">
						<input type="text" placeholder="请填写您的昵称" name="name" id="nameId" value="<?php echo $this->_tpl_vars['r'][0]->nickname; ?>
" />
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div class="iptDiv">
					...
					<div class="iptRight mezl_radio ">
						<?php if ($this->_tpl_vars['r'][0]->sex == 1): ?>
				...
				<div class="iptDiv">
					...
					<div class="iptRight">
						<input type="number" placeholder="请填写您的手机号" name="tel" id="telId" value="<?php echo $this->_tpl_vars['r'][0]->tel; ?>
" />
					</div>
					<div class="clearfix"></div>
				</div>

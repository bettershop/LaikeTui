<?php /* Smarty version 2.6.26, created on 2021-03-11 19:52:22
...
" id="" placeholder="规则名称" autocomplete="off" style="width:200px" class="input-text">
...
?>
                <tr class="text-c">
                    ...
                    <td><input name="is_default" id="is_default_<?php echo $this->_tpl_vars['item']->id; ?>
" onclick="is_default(<?php echo $this->_tpl_vars['item']->id; ?>
)" type="radio" value="<?php echo $this->_tpl_vars['item']->id; ?>
" style="margin-right: 5px;" <?php if ($this->_tpl_vars['item']->is_default == 1): ?>checked="checked"<?php endif; ?>>默认</td>
                    <td>
                        <a style="text-decoration:none" class="ml-5" href="index.php?module=freight&action=modify&id=<?php echo $this->_tpl_vars['item']->id; ?>
" title="修改">

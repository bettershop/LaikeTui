<?php /* Smarty version 2.6.26, created on 2020-12-28 14:09:17
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input style="width:200px" type="text" name="name" autocomplete="off" value="<?php echo $this->_tpl_vars['list']->name; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input style="width:200px" type="text" name="tel" autocomplete="off" value="<?php echo $this->_tpl_vars['list']->tel; ?>
" class="input-text">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="address" autocomplete="off" value="<?php echo $this->_tpl_vars['list']->address; ?>
" class="input-text">
                </div>
            </div>

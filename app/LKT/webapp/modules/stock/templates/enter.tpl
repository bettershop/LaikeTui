...
<nav class="breadcrumb">
    ...
    入货详情 <span class="c-gray en">&gt;</span> 
...
<div class="pd-20 page_absolute">
    ...
    <div class="swivch page_bgcolor swivch_bot">
            ...
            <a href="index.php?module=stock&action=enter" class="btn1 swivch_active" style="border-right: 1px solid #ddd!important;">入货详情</a>

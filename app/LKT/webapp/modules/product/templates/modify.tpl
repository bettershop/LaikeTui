    ...
    <div class="pd-20" id="page">
        ...
        <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="text" name="initial[cbj]" onkeypress="return noNumbers(event)" min="0"  step="0.01" onblur="set_cbj(this);" value="{$initial->cbj}" placeholder="请设置商品的默认成本价" >
                </div>
                <text style="line-height:30px;">克</text>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="text" name="initial[yj]" onkeypress="return noNumbers(event)" min="0"  step="0.01" onblur="set_yj(this);" value="{$initial->yj}" placeholder="请设置商品的默认原价" >
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="text" name="initial[sj]" onkeypress="return noNumbers(event)" min="0"  step="0.01" onblur="set_sj(this);" value="{$initial->sj}" placeholder="请设置商品的默认售价" >
                </div>
            </div>

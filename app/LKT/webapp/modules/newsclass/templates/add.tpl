...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe616;</i> 新闻管理 <span class="c-gray en">&gt;</span> 新闻分类管理 <span class="c-gray en">&gt;</span> 添加新闻分类 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=newsclass';" title="关闭" ><i class="Hui-iconfont">&#xe6a6;</i></a></nav>
<div class="pd-20">
    <form name="form1" class="form form-horizontal" method="post" onsubmit="return check(this);">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" name="cat_name" datatype="*6-18" style="width: 260px;">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">

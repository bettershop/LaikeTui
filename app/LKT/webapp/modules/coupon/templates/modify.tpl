    ...
    <form name="form1" action="index.php?module=coupon&action=modify" class="form form-horizontal" method="post"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" placeholder="" id="name" value="{$name}" name="name"
                       {if $activity_type==3}readonly{/if}>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl" style="display:{if $activity_type != 2}none{/if};" id="product_class_id"
             onchange="change()">
        ...
        <div class="row cl" id="txt">
            <label class="form-label col-4" id="txt_1" style="display:{if $activity_type == 3}none{/if};"><span
                        class="c-red">*</span>金额：</label>
            <label class="form-label col-4" id="txt_2" style="display:{if $activity_type != 3}none{/if};"><span
        ...
        <div class="row cl" id="time" style="display:{if $activity_type == 1}none{/if};">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                -
                <input type="text" class="input-text" value="{$end_time}" autocomplete="off" placeholder=""

    ...
    <form name="form1" action="index.php?module=sign&action=add" class="form form-horizontal" method="post" enctype="multipart/form-data" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input id="start_time" name="starttime" value="" class="scinput_s" style="width: 140px; height:26px;font-size: 14px;vertical-align: middle;" placeholder="开始时间">
-
                <input id="end_time" name="endtime" value="" class="scinput_s" style="width: 140px; height:26px;font-size: 14px;vertical-align: middle;" placeholder="结束时间">

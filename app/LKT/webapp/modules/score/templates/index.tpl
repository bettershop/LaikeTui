...
<div class="pd-20">
    <div>
    	<a href="index.php?module=score&action=setscore" class="btn1" style="width: 100px;">积分参数设置</a>
        
        <div class="clearfix" style="margin-top: 0px;"></div>
    </div>
    <div class="mt-20" style="clear:both;">
        <button class="btn newBtn radius" href="index.php?module=sign&action=add">

    ...
    <div class="add-menu">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="picture-ruleForm" label-width="100px">
        <el-form-item label="分类名称" prop="classname">
          <el-input v-model="ruleForm.classname" placeholder="请输入菜单名称"></el-input>
        </el-form-item>
        <el-form-item label="英文副标题" prop="subtitle">
          <el-input v-model="ruleForm.subtitle" placeholder="请输入导览名称"></el-input>
        </el-form-item>
        <el-form-item label="分类级别" prop="classlevel">
          <el-select class="select-input" v-model="ruleForm.classlevel" placeholder="请输入菜单等级">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        superiorclass: [
          { required: true, message: '请填上级分类', trigger: 'change' }
        ],
        select_2: [
  ...
  methods: {
    ...
    async getClassLevelTopAllInfos() {
      ...
      this.options3 = res.data.data.levelInfoList[2]
      this.ruleForm.select_4 = res.data.data.levelInfoList[2][0].cid
      this.options4 = res.data.data.levelInfoList[3]
      this.ruleForm.select_5 = res.data.data.levelInfoList[3][0].cid
    },
